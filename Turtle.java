...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    {
        Thread b1 = new Thread(new bob("Tomato", 0,0));
        Thread b2 = new Thread(new bob("darkorange",300,0));
        Thread b3 = new Thread(new bob("orangered",-300,0));
...
//                // pick pen (tail) up
//        bob.forward(60);    // move 40 units (pen up = no drawing)
//        bob.left(135);
//        bob.forward(84.85);
